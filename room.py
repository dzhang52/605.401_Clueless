...
class GameBoard(object):
  ...
  def initialize(self):
    ...
    self.hallways = [hallway1, hallway2, hallway3, hallway4, hallway5, hallway6, hallway7, hallway8, hallway9,
                     hallway10, hallway11, hallway12]
    ...
    self.board = self.concatenateMatrices(study.matrix, hallway1.matrix, hall.matrix, hallway2.matrix, lounge.matrix) + \
                 self.concatenateMatrices(hallway3.matrix, [[String(' ')]], hallway4.matrix, [[String(' ')]],
                                          hallway5.matrix) + \
                 self.concatenateMatrices(library.matrix, hallway6.matrix, billiardRoom.matrix, hallway7.matrix,
                                          diningRoom.matrix) + \
                 self.concatenateMatrices(hallway8.matrix, [[String(' ')]], hallway9.matrix, [[String(' ')]],
                                          hallway10.matrix) + \
                 self.concatenateMatrices(conservatory.matrix, hallway11.matrix, ballRoom.matrix, hallway12.matrix,
                                          kitchen.matrix)
